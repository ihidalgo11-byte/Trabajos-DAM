...
public abstract class Heroi extends Personatge implements Fight, Speak{
    ...
    // Constructor
    public Heroi(String nomHeroi, String respuestas[], String nom, int vida) {
        super(nom, vida);
    ...
    // Metodos
    public void defensar(String res) { // Enseña todas las respuetas, solicita un numero y devuelve el array de
        ...
        res = this.respuestas[respuestaUser - 1];
    }
