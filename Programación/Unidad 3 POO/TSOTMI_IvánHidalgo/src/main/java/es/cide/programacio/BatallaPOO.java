...
public class BatallaPOO {
        public static void main(String[] args) {
                ...
                System.out.println("");
                for (int bucle = 0; bucle < i.getCantidadPiratas(); bucle++) { // Bucle for para luchar con todos los
                                                                               // piratas
                        ...
                        while (h.getVivo() == true && p.getVivoPirata() == true) { // Bucle de la lucha de insultos
                                ...
                                System.out.println("");
                                respuestaUser = h.defensar(); // Imprime todas las respuestas y le pide al usuario un
                                                              // numero de respuesta
                                correcta = p.replica(respuestaUser); // Comprueba si la respuesta introducida es la
                                                                     // correcta
                                if (correcta) { // Si es correcta utiliza el metodo vida de pirata para quitarle 1 de
                                                // vida
                                        System.out.println("");
                                        System.out.println("Correcto");
                                        p.vida();
                                } else { // Si no es correcta utiliza el metodo vida de heroe para quitarle 1 de vida al
                                         // heroe
                                        System.out.println("");
